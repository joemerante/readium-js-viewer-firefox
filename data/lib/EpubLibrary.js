...
define(['jquery', 'bootstrap', 'storage/StorageManager', 'storage/Settings', 'EpubLibraryManager', 'i18n/Strings', 'hgn!templates/library-navbar.html', 
    ...
    // This still grabs a path to the file correctly 
		var file = evt.target.files[0];
    
    


    // TODO - keep trying various snippets of code to access the user's file directory once require('chrome') works to get Chrome 
    ...
    // fs.init(f, 0x02 | 0x08 | 0x20, 0664, 0); // write, create, truncate
